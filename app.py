...
def front_page():
    ...
    <style>
    .right-panel {
        background-color: rgba(0, 0, 0, 0.70);  /* 深色半透明背景 */
        padding: 3rem 2rem;
        border-radius: 20px;
        text-align: center;
    ...
    if os.path.exists(video_path):
        ...
        st.warning("请将 animation.mp4 放置在应用目录下")
        
    with col2:
        # 使用带class的div包裹内容，确保背景可见
        right_html = """
        <div class="right-panel">
            <h1>Welcome to<br>No-Code ML Platform</h1>
            <p>Build machine learning models without writing a single line of code.</p>
        </div>
        """
