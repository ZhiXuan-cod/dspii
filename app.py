...
# ---------- 首页 Front Page（最终版：深色背景框，蓝色按钮）----------
def front_page():
    set_bg_image_local("FrontPage.jpg")

    # 自定义CSS：右侧内容块样式（加深背景，文字阴影，蓝色按钮）
    st.markdown("""
    <style>
    div[key="right-panel"] {
